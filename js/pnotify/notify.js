(function(plugin) {
    ...
    var Message = function(options){
        ...
        this.element = $([
            ...
            '<div class="alert notify-message">',
                ...
                '<div style="margin-top: -2px;">'+this.options.message+'</div>',
            '</div>'
    ...
    $.extend(Message.prototype, {
        ...
        show: function() {
            ...
            this.element.css({"opacity":0, "margin-top": -1*this.element.outerHeight(), "margin-bottom":0}).animate({"opacity":1, "margin-top":'60px', "font-size": '15px',"margin-bottom":marginbottom}, function(){
