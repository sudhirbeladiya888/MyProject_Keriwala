<?php	
	function add_companies($param=array())
	{
	    ...
	    $company_id = $db->insert('tbl_companies',$data);
	    ...
	    {	
	    	...
	    	$outputjson['message'] = 'Comapny addedd Success';
	    }
	    else
	    {
	    	$outputjson['success'] = '0';
	    	$outputjson['data'] = [];
	    	$outputjson['message'] = 'Comapny addedd faild !!!!';
	    }
