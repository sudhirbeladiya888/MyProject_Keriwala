...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'img/', K_PATH_MAIN.'examples/images/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'logo-medium.png')) {
		$tcpdf_header_logo = 'logo-medium.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'CubicAnalytical');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'CubicAnalytical');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'CubicAnalytical');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "CubicAnalytical.com");
}
